  ...
  return (
    <>
      ...
      <Section bg="white" py="xl">
        <Container size="2xl">
          <div className="bg-white border-b border-stone-200 pt-16 pb-24 shadow-sm">
        ...
        <Container size="2xl">
          <div className="-mt-12 pb-20">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              {/* Tableau de bord - Mobile (Collapsible) */}
              <div className="lg:hidden mb-8">
                <Collapsible defaultOpen={false}>
                  <CollapsibleTrigger className="w-full flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 mb-4">
                  ...
                  <CollapsibleContent>
                    <Card className="rounded-[2rem] border-none shadow-xl bg-white overflow-hidden p-6">
                      <ProfileStats
                        postsCount={user._count.posts}
                        commentsCount={user._count.comments}
                      />
