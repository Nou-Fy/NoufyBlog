...
export function Footer({ isLoggedInServer }: FooterProps) {
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-full py-12 md:py-16">
              <div className="text-center space-y-4">
                ...
                <p className="text-emerald-100 text-lg max-w-2xl mx-auto">
                  Rejoignez notre communauté de mpiompy pour accéder à des
                  conseils exclusifs et partager votre expérience.
                </p>
                <Button
                  onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground">
                  La plateforme de référence pour les éleveurs malgaches.
                  Conseils pratiques, tutoriels et communauté engagée.
                </p>
              ...
              {/* QUICK LINKS */}
              <div className="space-y-4">
                <h4 className="text-orange-500 font-semibold">Navigation</h4>
              ...
              {/* RESOURCES */}
              <div className="space-y-4">
                <h4 className="text-orange-500 font-semibold">Ressources</h4>
                <ul className="space-y-2 text-sm">
                  {[
